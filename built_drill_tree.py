from drill_tree import DrillNode

drill_tree = DrillNode(
    prompt = 'Select training mode:',
    options = {
        'Specialized': DrillNode(
            prompt = 'Choose your area of growth:',
            options = {
                'Offense': DrillNode(
                    prompt = 'Position:',
                    options = {
                        'Seated Guard': DrillNode(
                            prompt = 'Opponent position:',
                            options = {
                                'Standing': DrillNode(
                                    prompt = 'Side to train:',
                                    options = {
                                        'Right': DrillNode(
                                            prompt = 'Finish:',
                                            options = {
                                                'Takedowns': DrillNode(
                                                    drills = [
                                                        ...
                                                        'Scoot under into right leg straight footlock position, finish sweep'
                                                    ]
                                                ),
                                                'Leg Locks': DrillNode(
                                                    drills = [
                                            ...
                                            options = {
                                                'Takedowns': DrillNode(
                                                    drills = [
                                                        ...
                                                        'Scoot under into left leg straight footlock position, finish sweep'
                                                    ]
                                                ),
                                                'Leg Locks': DrillNode(
                                                    drills = [
                                                        'Right hand inside knee pull, invert under legs, finish knee bar',
                                                        'Scoot under into left leg straight footlock position, sweep to footlock finish'
                                                    ]
                                                )
                                            }
                                        ),
                                            ...
                                            options = {
                                                'Leg Locks': DrillNode(
                                                    drills = [
                                                        ...
                                                        'Post left hand against same-side shoulder, hop out to left side with left leg between opponent, invert under legs, roll back into opponents\'s legs, finish knee bar'
                                                    ]
                                                )
                                            }
                                        ),
                                            ...
                                            options = {
                                                'Leg Locks': DrillNode(
                                                    drills = [
                                                        ...
                                                        'Right leg reverse butterfly hook, full sweep leg entry option, finish knee bar'
                                                    ]
                                                )
                                            }
                                        ),
                                    ...
                                    options = {
                                        ...
                                        'Left': DrillNode(
                                            ...
                                            options = {
                                                'Sweeps': DrillNode(
                                                    drills = [
                                                        'Right leg reverse butterfly hook, opponent\'s right arm reaches over your shoulder, left hand far trap grip, right hand chin-strap, roll over sweep to right'
                                                    ]
                                                )
                                            }
                                        ),
                        ...
                        'Half Guard Bottom': DrillNode(
                            prompt = 'Opponent position:',
                            options = {
                                'Inside knee down': DrillNode(
                                    prompt = 'Side to train:',
                                    options = {
                                        'Right': DrillNode(
                                            prompt = 'Finish:',
                                        ...
                                        'Left': DrillNode(
                                            ...
                                            options = {
                                                'Sweeps': DrillNode(
                                                    drills = [
                                                        'Right leg between opponent\'s legs under their right shin, left leg wrapped over top opponent\'s leg, opponent\'s knee is past bottom thigh, secure left hand under hook to far side ribs and right hand grip behind opponent\'s left knee, opponent secures whizzer, begin to walk hips under opponent using right foot, once under opponent continue sweeping motion to the left',
                                                        'Right leg between opponent\'s legs, angle upper-body towards opponent\'s far hip, knee lever sweep'
                                                    ]
                                                ),
                                                'Back Takes': DrillNode(
                                                    drills = [
                                    ...
                                    options = {
                                        ...
                                        'Left': DrillNode(
                                            ...
                                            options = {
                                                'Leg Locks': DrillNode(
                                                    drills = [
                                                        'Right leg between opponent\'s legs, right foot behind opponent\'s achilles pushing, establish left leg butterfly hook, with both hands under crossface armpit kick and push to extend away, finish knee bar'
                                                    ]
                                                ),
                                                'Takedowns': DrillNode(
                                                    drills = [
                                                        'Right leg between opponent\'s legs, right foot behind opponent\'s achilles pushing, establish left leg butterfly hook, with both hands under crossface armpit kick and push to extend away, secure legs to take down'
                                                    ]
                                                )
                                            }
                                        ),
                                            ...
                                            options = {
                                                'Takedowns': DrillNode(
                                                    drills = [
                                                        ...
                                                        'Establish left hand wizar on opponent\'s right arm, right foot replaces left, left foot kicks the inside of opponent\'s near leg, post right hand on ground and hop into opponent while raising left leg elevating hip, finish take down'
                                                    ]
                                                ),
                                                'Leg Locks': DrillNode(
                                                    drills = [
                                                        'While four-pointed with hands and feet and opponent left side body lock, angle towards opponent\'s left leg, drop low and slide through legs on right-side outer-thigh, safely grab elbow-deep grip behind opponent\'s left knee while sliding under legs, establish saddle on the left leg and finish knee bar.'
                                                    ]
                                                )
                                            }
                                        ),
                                    ...
                                    options = {
                                        'Strangles': DrillNode(
                                            drills = [
                                                ...
                                                'Two hooks in, fall to left side establishing body triangle, left side kimura grip, transition to arm bar position, leg wrestle sweep back into back control, finish left arm rear-naked-choke'
                                            ]
                                        ),
                                        'Arm Locks': DrillNode(
                                            drills = [
                                                'Two hooks in, fall to left side establishing body triangle, left side kimura grip, transition to arm bar position and finish'
                                            ]
                                        )
                                    }
                                ),
                                            ...
                                            options = {
                                                'Strangles': DrillNode(
                                                    drills = [
                                                        ...
                                                        'Right leg in between, left leg stapled over top, opponent bases up on far elbow, secure Dagestani grip and break posture down, use left shoulder and under right arm to roll over opponent, lock up legs and hip into opponent right hip, finish rear naked choke'
                                                    ]
                                                )
                                            }
                                        ),
                                            ...
                                            options = {
                                                'Strangles': DrillNode(
                                                    drills = [
                                                        ...
                                                        'Right leg stapled over top, secure right-hand grip around opponent\'s head, slide arm around opponent\'s neck, stay on top with pressure and finish arm-in ezekiel'
                                                    ]
                                                ),
                                                'Arm Locks': DrillNode(
                                                    drills = [
                                                        'Right leg stapled over top, secure right-hand placement under oppenent\'s right arm and behind head, secure kimura grip, swing left leg around over face, fully transition and fall over to finish arm bar'
                                                    ]
                                                )
                                            }
                                        ),
                        ...
                        'Turtle': DrillNode(
                            ...
                            options = {
                                    ...
                                    options = {
                                        ...
                                        'Left': DrillNode(
                                            ...
                                            options = {
                                                'Leg Locks': DrillNode(
                                                    drills = [
                                                        'Left arm over opponent\'s left leg for the over wrap, roll to left side keeping knees close to chest, secure opponent\'s top leg between legs and cross feet, secure leg under armpit, optionally secure opponent\'s bottom leg under right leg, finish knee bar'
                                                    ]
                                                )
                                            }
                                        ),
                                ...
                                'Leg-between rear body lock': DrillNode(
                                    prompt = 'Side to train:',
                                    options = {
                                        'Right': DrillNode(
                                            prompt = 'Finish:',
                                        ...
                                        'Left': DrillNode(
                                            ...
                                            options = {
                                                'Leg Locks': DrillNode(
                                                    drills = [
                                                        'With right leg between opponent\'s legs, straighten left leg and roll onto right shoulder grabbing a deep scoop grip with right arm behind opponent\'s left knee, continue roll momentum using left leg to extend and push opponent away, establish grip on opponent\'s left heel with left hand and pull foot up towards left shoulder while hipping up and crossing legs, finish knee bar'
                                                    ]
                                                )
                                            }
                                        ),
                            ...
                            options = {
                                'Right': DrillNode(
                                    ...
                                    options = {
                                        'Leg Locks': DrillNode(
                                            drills = [
                                                'Hook left arm elbow-deep behind opponent\'s right leg, with right leg, hook foot on inside of opponent\'s left ankle, cross left leg over right and flare opponent\'s leg out to the side for correct angle on knee, bridge up while gripping hands around opponent\'s waist to finish dog bar'
                                            ]
                                        )
                                    }
                                ),
                                'Left': DrillNode(
                                    ...
                                    options = {
                                        'Leg Locks': DrillNode(
                                            drills = [
                                                'Hook right arm elbow-deep behind opponent\'s left leg, with left leg, hook foot on inside of opponent\'s right ankle, cross right leg over left and flare opponent\'s leg out to the side for correct angle on knee, bridge up while gripping hands around opponent\'s waist to finish dog bar'
                                            ]
                                        )
                                    }
                                ),
                                    ...
                                    options = {
                                        'Leg Locks': DrillNode(
                                            drills = [
                                                ...
                                                'Establish elbow-deep grip with right arm behind opponent\'s left knee, remove knee shield and kick left leg onto right side and come up as far as possible, bumping butt into opponent\'s chest to off-balance them back, use left hand to grab opponent\'s heel and pull foot to chest, opponent rolls over their left shoulder, follow leg and cross feet, finish knee bar'
                                            ]
                                        )
                                    }
                                ),
                                    ...
                                    options = {
                                        'Leg Locks': DrillNode(
                                            drills = [
                                                ...
                                                'Establish under-leg scoop grip with right arm on opponent\'s top leg, knee slide left knee across to other side and left-hand post, opponent turns away, switch right arm grip to left arm, follow opponent turn by falling to right hip while simultaneusly grabbing opponent\'s bottom ankle with right hand, securing it under left leg for double leg control, finish left lat knee bar'
                                            ]
                                        )
                                    }
                                ),
                        ...
                        'Knee on Belly Bottom': DrillNode(
                            prompt = 'Side to train:',
                            options = {
                                'Right': DrillNode(
                                    prompt = 'Finish:',
                                    ...
                                    options = {
                                        'Leg Locks': DrillNode(
                                            drills = [
                                                ...
                                                'Opponent pendulums left leg pushing to get away, go with this momentum and windshield-wipe feet so right foot is stapled across opponent\'s bottom leg, reach around with left arm to grab opponent\'s left leg, step over with left leg and swing it all the way under opponent\'s butt, using momentum fall to left side and finish left lat knee bar'
                                            ]
                                        )
                                    }
                                ),
                                            ...
                                            options = {
                                                'Arm Locks': DrillNode(
                                                    drills = [
                                                        ...
                                                        'With right knee on belly, grab opponent\'s right wrist with left hand, place right hand on their far hip, distribute weight to the right and swing right foot under near-side shoulder blade, simultaneously swing left leg over opponent\'s face, finish arm bar'
                                                    ]
                                                )
                                            }
                                        ),
                                    ...
                                    options = {
                                        'Right': DrillNode(
                                            ...
                                            options = {
                                                'Leg Locks': DrillNode(
                                                    drills = [
                                                        'With right knee on belly, roll to right side while peeking through the legs with both arms and establishing a left lat grip on opponent\'s left leg, keep right foot shallow into opponent\'s groin, throw left leg reap over opponent\'s top leg, finish left lat knee bar'
                                                    ]
                                                )
                                            }
                                        ),
                            ...
                            options = {
                                ...
                                'Left': DrillNode(
                                    ...
                                    options = {
                                        'Leg Locks': DrillNode(
                                            drills = [
                                                'Right leg between opponent\'s legs left knee on hip, opponent attempts hip switch, catch them on knee and elbow frames, while turning onto left hip use left hand and elbow to push opponent away, bring left leg under opponent while throwing right leg over the top, cross legs and finish knee bar'
                                            ]
                                        ),
                                        'Arm Locks': DrillNode(
                                            drills = [
                                                ...
                                                'Right leg between opponent\'s legs left knee on hip, establish kimura grip on opponent\'s left arm, opponent blocks left leg swing with right arm, bring knee to opponent\'s left shoulder, push opponent\'s head away with knee and throw left leg over their back heavy, transition left leg over the left shoulder shallow back heeling tight, bring feet together, opponent rolls over, secure left foot behind opponent\'s head and right foot over the top, finish arm bar over left hip'
                                            ]
                                        ),
                                        'Strangles': DrillNode(
                                            drills = [
                                                ...
                                                'Right leg between opponent\'s legs left knee on hip, establish kimura grip on opponent\'s left arm, bring knee to opponent\'s left shoulder, push opponent\'s head away with knee and throw left leg over their back heavy, shoot lower leg through gap between opponent\'s far elbow and knee, lock up right foot behind left knee keeping opponent\'s posture down, release kimura grip and climb for height to left arm grip body lock style, use left foot on ground to turn and come up more while retracting right knee, begin hipping weight into opponent\'s back and squeezing legs to finish yoko ono triangle strangle'
                                            ]
                                        ),
                                        'Sweeps': DrillNode(
                                            drills = [
                                                'Right leg between opponent\'s legs left knee on hip, opponent attempts hip switch, catch them on knee and elbow frames, while keeping knees and elbows tight use opponent\'s momentum and kick legs up and back while rolling backwards, finish sweep on top'
                                            ]
                                        )
                                    }
                                ),
                    ...
                    options = {
                        'Leg Locks': DrillNode(
                            drills = [
                                ...
                                'Day la heeva seated opponent right side, opponent opens leg out, post on hip and up on bottom knee, finish day la heeva straight footlock'
                            ]
                        ),
                        'Arm Locks': DrillNode(
                            drills = [
                        ...
                        'Positional Advancements': DrillNode(
                            drills = [
